            ...
            if (isGeoTiff(config) || isCloudOptimizedGeoTIFF(config)) {
                ...
                if (quicklookImage != null) {
                    ...
                    if (isCloudOptimizedGeoTIFF(config)) {
                        ...
                        boolean gdalLoaded = true;
                        if (driverGeoTiff == null) {
                            LOGGER.warning("Could not load GDAL GTiff driver");
                            gdalLoaded = false;
                        }
                        if (driverCOG == null) {
                            LOGGER.warning("Could not load GDAL COG driver");
                            gdalLoaded = false;
                        }
                        if (gdalLoaded) {
                            ...
                            /*
                            // Add GDAL specific control parameters for the GTiff driver, if required in future
